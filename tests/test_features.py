...
class TestFormatting(unittest.TestCase):
    ...
    def test_activity_ball_sport_no_elevation(self) -> None:
        act = Activity(
            ...
            moving_time_s=3600,
            elapsed_time_s=3600,
            total_elevation_gain=120.0,  # Should be ignored for volleyball
            average_speed=None,
            max_speed=None,
    ...
    def test_health_vitals_hr_buckets(self) -> None:
        daily = [
        ...
        buckets = [
            HrBucket(day="2026-09-01", start_hour=0, end_hour=6, avg_hr=55, min_hr=48, max_hr=68, avg_hrv=45.5),
            HrBucket(day="2026-09-01", start_hour=6, end_hour=12, avg_hr=72, min_hr=58, max_hr=105, avg_hrv=38.2),
        ]
        ...
        self.assertIn('<day date="2026-09-01" readiness="85" steps="9200">', out)
        self.assertIn('<hr_buckets>', out)
        self.assertIn('<bucket start="00:00" end="06:00" avg_hr="55" min_hr="48" max_hr="68" avg_hrv="45.5"/>', out)
        self.assertIn('<bucket start="06:00" end="12:00" avg_hr="72" min_hr="58" max_hr="105" avg_hrv="38.2"/>', out)
